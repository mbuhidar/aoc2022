...
def get_modulus(monkeys: Any) -> int:
    return reduce(lambda x, y: x*y, [monkey.test for monkey in monkeys])
...
class Monkey:
    ...
    def take_turn(
        self, relief_factor: int, monkeys: Any, modulus: int,
    ) -> None:
...
def compute(s: str) -> int:
    ...
    for _ in range(10000):
        for monkey in monkeys:
            ...
            monkey.take_turn(RELIEF_FACTOR, monkeys, modulus)
